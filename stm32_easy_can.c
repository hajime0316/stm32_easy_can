...
//*********************************************************
//    stm32_easy_can_get_receive_message
//*********************************************************
//  [概要]
//    受信データ取得
//  [引数]
...
//*********************************************************
//    stm32_easy_can_transmit_message
//*********************************************************
//  [概要]
//    データ送信
//  [引数]
...
//    その中で書く．
//--------------------------------------------------------
__weak void stm32_easy_can_interrupt_handler(void)
{
	// デフォルトでは何もしない
    return;
}
